...
/**
 * Ohmcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzohmcseed(const UniValue& params, bool fHelp);
extern UniValue getzohmcseed(const UniValue& params, bool fHelp);
...
extern UniValue obfuscation(const UniValue& params, bool fHelp); // in rpckarmanode.cpp
extern UniValue getpoolinfo(const UniValue& params, bool fHelp);
extern UniValue karmanode(const UniValue& params, bool fHelp);
extern UniValue listkarmanodes(const UniValue& params, bool fHelp);
extern UniValue getkarmanodecount(const UniValue& params, bool fHelp);
extern UniValue createkarmanodebroadcast(const UniValue& params, bool fHelp);
extern UniValue decodekarmanodebroadcast(const UniValue& params, bool fHelp);
extern UniValue relaykarmanodebroadcast(const UniValue& params, bool fHelp);
extern UniValue karmanodeconnect(const UniValue& params, bool fHelp);
extern UniValue karmanodecurrent(const UniValue& params, bool fHelp);
extern UniValue karmanodedebug(const UniValue& params, bool fHelp);
extern UniValue startkarmanode(const UniValue& params, bool fHelp);
extern UniValue createkarmanodekey(const UniValue& params, bool fHelp);
extern UniValue getkarmanodeoutputs(const UniValue& params, bool fHelp);
extern UniValue listkarmanodeconf(const UniValue& params, bool fHelp);
extern UniValue getkarmanodestatus(const UniValue& params, bool fHelp);
