...
static const CRPCCommand vRPCCommands[] =
        ...
        {"generating", "setgenerate", &setgenerate, true, true, false},
                ...
                /* Ohmcoin features */
                {"ohmcoin", "karmanode", &karmanode, true, true, false},
                {"ohmcoin", "listkarmanodes", &listkarmanodes, true, true, false},
                {"ohmcoin", "createkarmanodebroadcast", &createkarmanodebroadcast, true, true, false},
                {"ohmcoin", "decodekarmanodebroadcast", &decodekarmanodebroadcast, true, true, false},
                {"ohmcoin", "relaykarmanodebroadcast", &relaykarmanodebroadcast, true, true, false},
                {"ohmcoin", "getkarmanodecount", &getkarmanodecount, true, true, false},
                {"ohmcoin", "karmanodeconnect", &karmanodeconnect, true, true, false},
                {"ohmcoin", "karmanodecurrent", &karmanodecurrent, true, true, false},
                {"ohmcoin", "karmanodedebug", &karmanodedebug, true, true, false},
                {"ohmcoin", "startkarmanode", &startkarmanode, true, true, false},
                {"ohmcoin", "createkarmanodekey", &createkarmanodekey, true, true, false},
                {"ohmcoin", "getkarmanodeoutputs", &getkarmanodeoutputs, true, true, false},
                {"ohmcoin", "listkarmanodeconf", &listkarmanodeconf, true, true, false},
                {"ohmcoin", "getkarmanodestatus", &getkarmanodestatus, true, true, false},
                {"ohmcoin", "getkarmanodewinners", &getkarmanodewinners, true, true, false},
                {"ohmcoin", "getkarmanodescores", &getkarmanodescores, true, true, false},
                {"ohmcoin", "knbudget", &knbudget, true, true, false},
                {"ohmcoin", "preparebudget", &preparebudget, true, true, false},
                {"ohmcoin", "submitbudget", &submitbudget, true, true, false},
                {"ohmcoin", "knbudgetvote", &knbudgetvote, true, true, false},
                {"ohmcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
                {"ohmcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
                {"ohmcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
                {"ohmcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
                {"ohmcoin", "knbudgetrawvote", &knbudgetrawvote, true, true, false},
                {"ohmcoin", "knfinalbudget", &knfinalbudget, true, true, false},
                {"ohmcoin", "checkbudgets", &checkbudgets, true, true, false},
                {"ohmcoin", "knsync", &knsync, true, true, false},
                {"ohmcoin", "spork", &spork, true, true, false},
                {"ohmcoin", "getpoolinfo", &getpoolinfo, true, true, false},
                {"ohmcoin", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzohmcseed", &getzohmcseed, false, false, true},
        {"zerocoin", "setzohmcseed", &setzohmcseed, false, false, true}
...
{
    return "> ohmcoin-cli " + methodname + " " + args + "\n";
}
