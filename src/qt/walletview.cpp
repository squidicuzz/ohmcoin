                                          ...
                                          walletModel(0)
{
    ...
    if (settings.value("fShowKarmanodesTab").toBool()) {
        karmanodeListPage = new KarmanodeList();
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowKarmanodesTab").toBool()) {
        karmanodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowKarmanodesTab").toBool()) {
        karmanodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoKarmanodePage()
{
    QSettings settings;
    if (settings.value("fShowKarmanodesTab").toBool()) {
        setCurrentWidget(karmanodeListPage);
    }
}
