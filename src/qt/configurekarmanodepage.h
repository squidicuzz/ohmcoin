...
#ifndef BITCOIN_QT_CONFIGUREKARMANODEPAGE_H
 ...
 */
class ConfigureKarmanodePage : public QDialog
{
    Q_OBJECT

public:
    enum Mode {
        NewConfigureKarmanode,
        EditConfigureKarmanode
    };

    explicit ConfigureKarmanodePage(Mode mode, QWidget* parent);
    ~ConfigureKarmanodePage();
